...
class ContextControllerTest {
    private static final String WEB_API_URI = "/__webapi__/context";
    ...
    void getAll() throws Exception {
        when(service.getAsString()).thenReturn(TEXT);
    ...
    void WHEN_setAndExceptionThrown_THEN_ReturnsBadRequest() throws Exception {
        doThrow(RuntimeException.class).when(service).setFromString(any());
