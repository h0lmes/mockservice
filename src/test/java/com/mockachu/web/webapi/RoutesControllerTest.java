...
class RoutesControllerTest {
    private static final String WEB_API_ROUTES = "/__webapi__/routes";
    ...
    void getRoutes() throws Exception {
        ...
        mvc.perform(get(WEB_API_ROUTES).contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
    ...
    @Test
    void getRoutes_ExceptionThrown_ReturnsBadRequest() throws Exception {
    ...
    void patchRoutes() throws Exception {
        ...
        mvc.perform(patch(WEB_API_ROUTES)
    ...
    void putRoutes() throws Exception {
        ...
        mvc.perform(put(WEB_API_ROUTES)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void postRoutes() throws Exception {
        ...
        mvc.perform(post(WEB_API_ROUTES)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonMapper.writeValueAsBytes(List.of(dto))))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    void deleteRoutes() throws Exception {
        ...
        mvc.perform(delete(WEB_API_ROUTES)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonMapper.writeValueAsBytes(List.of(dto))))
                .andDo(print())
                .andExpect(status().isOk())
