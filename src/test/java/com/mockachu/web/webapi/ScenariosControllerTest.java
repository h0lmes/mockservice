...
class ScenariosControllerTest {
    private static final String WEB_API_SCENARIOS = "/__webapi__/scenarios";
    private static final String WEB_API_SCENARIOS_ACTIVE = "/__webapi__/scenarios/active";
    ...
    @Test
    void putScenario() throws Exception {
    ...
    @Test
    void putScenario_ScenarioAlreadyExistsExceptionThrown_BadRequest() throws Exception {
        Scenario empty = new Scenario();
        Scenario scenario = new Scenario().setAlias(ALIAS);
    ...
    @Test
    void putScenario_ScenarioParseExceptionThrown_BadRequest() throws Exception {
        Scenario empty = new Scenario();
        Scenario scenario = new Scenario().setAlias(ALIAS);
    ...
    @Test
    void putActiveScenario() throws Exception {
    ...
    @Test
    void deleteActiveScenario() throws Exception {
