...
class RouteTest {
    ...
    @Test
    void setAlt_Null_AltIsEmptyString() {
        assertTrue(new Route().setAlt(null).getAlt().isEmpty());
    }

    @Test
    void setResponse_Null_ResponseIsEmptyString() {
        assertTrue(new Route().setResponse(null).getResponse().isEmpty());
    }

    @Test
    void setRequestBodySchema_Null_RequestBodySchemaIsEmptyString() {
    ...
    @Test
    void setResponseCodeString_In100To599_SetsResponseCode() {
        assertEquals(400, new Route().setResponseCodeString("400").getResponseCode());
    }

    @Test
    void setResponseCodeString_LessThan100_DoesNotChangeResponseCode() {
        assertEquals(new Route().getResponseCode(), new Route().setResponseCodeString("99").getResponseCode());
    }

    @Test
    void setResponseCodeString_GreaterThan599_DoesNotChangeResponseCode() {
